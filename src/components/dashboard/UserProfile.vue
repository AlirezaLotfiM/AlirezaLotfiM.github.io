...
const { navigateFromEvent, tabPaths } = useNavigation();
...
<template>
  <aside class="col-profile">
    ...
    <div v-show="isPlayerMinimized" class="glass-panel contact-grid social-dock">
      ...
      <div class="contact-wrapper">
        <a :href="profile.contact?.linkedin" target="_blank" rel="noopener noreferrer" class="contact-btn linkedin" aria-label="LinkedIn">
          <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="contact-wrapper">
        <a :href="profile.contact?.telegramUrl" target="_blank" rel="noopener noreferrer" class="contact-btn telegram" aria-label="Telegram">
          <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="contact-wrapper">
        <a :href="`https://github.com/${userGithub}`" target="_blank" rel="noopener noreferrer" class="contact-btn github" aria-label="GitHub">
          <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
